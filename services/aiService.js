...
          topK: config.topK || 40,
          // Ensure JSON mode is set if a schema is provided
          responseMimeType: responseSchema ? "application/json" : "text/plain",
          // Ensure responseSchema is included for JSON output
...
          // Fallback: try to extract JSON object from malformed response
...
      // Re-throw the error to be handled by the calling function (e.g., fallback)
      throw error;
    }
  }

  // ===== File Processing Methods (NO CHANGES NEEDED) =====
...
  // ===== Job Description Generation (NO CHANGES NEEDED) =====
...
  // ===== Interview Questions Generation (NO CHANGES NEEDED) =====
...
  // ===== Candidate Insights (NO CHANGES NEEDED) =====
...
  // ===== AI Report Generation (NO CHANGES NEEDED) =====
...
  // ===== Fallback/Mock Methods (NO CHANGES NEEDED) =====
...
---
*This is a mock report used due to missing API key or AI model error.*
`;
  }
}
