...
        // If JSON format is required, include the schema
        ...(responseFormat === 'json' && { responseSchema: this.analysisResponseSchema })
      };
...
  // --- Core Service Methods (NO CHANGES NEEDED) ---
...
    // This method currently doesn't use the JSON schema approach in the `callGeminiAI` wrapper, 
    // but relies on the fallback model name and API key logic which is now updated.
    try {
...
  // --- Prompt Creation and Mock Data (NO CHANGES NEEDED) ---
